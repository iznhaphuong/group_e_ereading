...
@push('footer-js')
    <script src="{{ asset('js/script-13.js') }}"></script>
@endpush
                    ...
                    <form>
                        ...
                        <div class="mb-6">
                            <input type="text"
                                ...
                                id="exampleFormControlInput2" placeholder="Tài khoản / Email" />
                        </div>
                        ...
                        <div class="flex justify-between items-center mb-6">
                            <div class="form-group form-check">
                                <input type="checkbox"
                                    ...
                                    id="exampleCheck2" />
                                <label class="form-check-label inline-block text-gray-800" for="exampleCheck2">Nhớ
                                    tài khoản</label>
                            </div>
