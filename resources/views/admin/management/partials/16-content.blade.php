{{-- My CSS File --}}
@push('head-css')
    <link name="style-16" rel="stylesheet" href="{{ asset('css/style-16.css') }}">
@endpush
        ...
        <div class="e-panel card">
          <div class="card-body">
            <div class="card-title">
              ...
              <button class="btn btn-success btn-block" style="float: right;width:250px;margin-bottom:15px;" type="button" data-toggle="modal" data-target="#user-form-modal">Thêm Người Dùng</button>
            </h6>
            </div>
            <div class="e-table">
                ...
                <table class="table table-bordered">
                  <thead>
                    <tr>
                      ...
                      <th>Avatar</th>
                      <th class="max-width">Tên người dùng</th>
                      <th class="sortable">Tên đăng nhập</th>
                      <th>Mật khẩu </th>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="text-nowrap align-middle"><span>User</span></td>
                        <td class="text-nowrap align-middle"><span>Email</span></td>
                      <td class="text-center align-middle">123123</td>
                      <td class="text-center align-middle">thường</td>
